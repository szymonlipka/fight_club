class Fight < ActiveRecord::Base
  ...
  def find_winner
    ...
    (winner.learning == 0) ? (winning_exp = winner.experience + 50) : (winning_exp = winner.experience + (50 * (winner.learning * 2)))
    (looser.inference == 0) ? (loosing_exp = looser.experience + 50) : (loosing_exp = looser.experience + (50 * (looser.inference * 2)))
